...
namespace WebApp.Strategy.Controllers
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Price,Stock,AppUserId,CreatedDate")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(string id, [Bind("Id,Name,Price,Stock,AppUserId,CreatedDate")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
